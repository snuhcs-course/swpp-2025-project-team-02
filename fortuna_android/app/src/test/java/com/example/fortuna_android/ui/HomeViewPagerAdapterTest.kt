...
/**
 * Unit tests for HomeViewPagerAdapter
 * Tests ViewPager2 adapter functionality with 100% coverage
 */
@RunWith(RobolectricTestRunner::class)
@Config(sdk = [28])
class HomeViewPagerAdapterTest {
    ...
    fun setUp() {
        ...
        adapter = HomeViewPagerAdapter(parentFragment)
    }
    ...
    fun `test adapter can be created with different parent fragment`() {
        ...
        // Act
        val newAdapter = HomeViewPagerAdapter(newParentFragment)
